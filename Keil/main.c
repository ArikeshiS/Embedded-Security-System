//ARIKESHI SRIVASTAVA - 19BCE10038
#include <reg51.h>
...
void check()
{
 if (pin[0] == Epin[0] && pin[1] == Epin[1] && pin[2] == Epin[2] && pin[3] == Epin[3] && pin[4] == Epin[4])
 {
	...
	{
		lcdcmd(0x01); //decimal value: 1
		lcdcmd(0xc1); //decimal value: 128
		lcddisplay("Incorrect");
		lcdcmd(0xc0);
		delay(1000);
		lcdcmd(0x01); //decimal value: 1
			b1 = 0;
